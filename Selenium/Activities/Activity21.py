...
with webdriver.Firefox(service=service) as driver:
    ...
    wait.until(selenium.webdriver.support.expected_conditions.number_of_windows_to_be(2))
    ...
    # Wait for new tab/window to open
    wait.until(selenium.webdriver.support.expected_conditions.number_of_windows_to_be(3))
    # Print the handles of all the windows
    print("All window handles: ", driver.window_handles)
